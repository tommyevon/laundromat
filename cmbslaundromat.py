...
class CMBS():
    ...
    def Go(self):
        ...
        uk = CMBS.scrape(start_date = 'Jun 23, 2011', rawtxt = 'CMBS_Other_raw_historical.txt', type = 'Other')
        moto = CMBS.scrape(start_date = 'Jun 25, 2010', rawtxt = 'CMBS_LLSASB_raw_historical.txt', type = 'LLSASB')
        floor = CMBS.scrape(start_date = 'Sep 24, 2012', rawtxt = 'CMBS_CRE_raw_historical.txt', type = 'CRE')
        lease = CMBS.scrape(start_date = 'Aug 4, 2010', rawtxt = 'CMBS_Conduit_raw_historical.txt', type = 'Conduit')
        subprime = CMBS.scrape(start_date = 'Oct 3, 2010', rawtxt = 'CMBS_Agency_raw_historical.txt', type = 'Agency')
        ...
        odf.to_csv('cmbs_master_database.csv', index = True)
